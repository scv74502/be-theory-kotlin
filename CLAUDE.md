...
1. **/Users/kwp/Desktop/Workspace/week1-TDD/docs/groundRules - 작업물 작성 시 지켜야 할 규칙, 프로젝트 워크플로우 정의서, 마스터(감독) 에이전트가 워크플로우 구축 시 사용**
2. **/Users/kwp/Desktop/Workspace/week1-TDD/docs/projectInfo - 프로젝트 간단 정보 및 기술 스택, 마스터 에이전트의 평가와 구현-테스트 에이전트의 구현 시 사용**
