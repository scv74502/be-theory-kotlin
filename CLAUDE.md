...
5. **/Users/kwp/Desktop/Workspace/be-theory-kotlin/docs/design/01-requirements.md ~ 04-erd.md - 도메인 용어(유비쿼터스 언어), 요구사항, 시퀀스/클래스/ERD 의 SoT. 코드보다 우선하며 도메인 작업 시 agent_rules 와 함께 필수 선행 참조한다. 본 문서는 작업·아키텍처 지침이 아니라 도메인 사실(fact) 의 원천이다.**
